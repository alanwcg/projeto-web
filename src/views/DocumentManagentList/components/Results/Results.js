...
const Results = props => {
  const { className, page, size, order, orderBy, onRequestSort, onRequestPagination, isLoading, documents, numberOfElements, totalPages, fetchDocuments, deleteDocuments, ...rest } = props;
  ...
  return (
    ...
    >
      <Card>
        <TableToolbar
          title="Todos as contas de usuário"
          numSelected={selectedDocuments.length}
          onDelete={() => deleteDocuments(selectedDocuments, setSelectedResults)}
        />
        <Divider />
